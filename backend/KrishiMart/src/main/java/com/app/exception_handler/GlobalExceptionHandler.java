...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<?> handleUserAlreadyExistsException(CustomerAlreadyExistException e)
	{
	...
	public ResponseEntity<?> handleUserAlreadyExistsException(ResourceNotFoundException e)
	{
		System.out.println("err " + e);
		return ResponseEntity.status(HttpStatus.CONFLICT).body(e.getMessage());
